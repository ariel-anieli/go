...
havem:
	...
	ADDV	$8, R3, R19
	SUBVU	R3, R19, R19	// R19 is our actual frame size
	SUBVU	R19, R13	// Allocate the same frame size on the g stack
	MOVV	R13, R3		// switch stack

	MOVV	R4, 0(R3)	// "saved LR"
	MOVV	R5, 8(R3)
	MOVV	R6, 16(R3)
	MOVV	R7, 24(R3)
	MOVV	$runtime·cgocallbackg<ABIInternal>(SB), R19
	JAL	(R19)
